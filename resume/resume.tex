...
\begin{position}
  ...
  refactored to remove Noir when the maintainers deprecated it. Initiated formalization of git workflow
  and code review process. I also attended Strange Loop in St. Louis and took
  \href{http://blog.redlinernotes.com/posts/Strange-Loop-Notes---Day-2.html}{lots} of
...
\begin{position}
  I worked on a 160k SLOC Python/Django project to serve Newspaper, TV, and Radio publishers.
  I had particular focuses on admin customization and data migration. I oversaw the migration of over
  100K users from multiple markets to our new CMS. I added checks to prevent creation of duplicate ad
  mappings by Ad Ops. I wrote a mixin enabling any content type to be trivially published to multiple
  sites via a user-friendly admin action. I added a flexible save-as-new action with pre-hook,
  post-hook, and copy-excludes hooks to allow behavior tweaks for various models. I implemented Yahoo!
  Web Search and Sponsored Ads and integrated it with our site search support. I made broad
  improvements to our Brightcove video import scripts using celery and memcached. I also gave talks on
  \href{http://redlinernotes.com/docs/talks/opa.html}{``Programmer Archaeology''},
...
\begin{position}
  romreader is an extensible library for reading ROM formats, often used to store
  binary images for old hardware. It is a small and clean example of Object Orientation
  in Lisp and the support for original Nintendo ROMs is under 100 lines. It is currently
  being used in my work-in-progress NES emulator.
\end{position}
